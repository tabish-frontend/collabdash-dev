...
//     reason:
//       "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tenetur rerum commodi, molestias unde provident explicabo odio quasi corrupti rem quo?",
//     status: "Approved",
//   },
//   {
//     leave_type: "Sick",
...
export const LeavesCard = ({ employeeId }: { employeeId: string | any }) => {
  ...
  const [filter, setFilter] = useState<Date | null>(currentDate);
