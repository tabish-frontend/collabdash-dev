...
export const CalendarContainer = styled("div")(({ theme }) => ({
  ...
  "& .fc-scroller": {
    ...
    scrollbarColor: `${theme.palette.grey[600]} ${theme.palette.background.default}`, // For Firefox
  },
  "& .fc-scroller::-webkit-scrollbar": {
    width: "8px", // Set width for Chrome/Safari
  ...
  "& .fc-scroller::-webkit-scrollbar-track": {
    background: theme.palette.background.default, // Track color
  },
}));
