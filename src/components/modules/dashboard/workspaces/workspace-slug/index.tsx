...
const WorkSpaceSlug: NextPage = () => {
  return <WorkSpaceSlugComponent />;
};

WorkSpaceSlug.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
